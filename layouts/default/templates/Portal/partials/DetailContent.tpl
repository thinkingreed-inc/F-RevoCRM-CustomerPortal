...
{literal}
    <div ng-class="{'col-lg-5 col-md-5 col-sm-12 col-xs-12 leftEditContent':splitContentView, 'col-lg-12 col-md-12 col-sm-12 col-xs-12 leftEditContent nosplit':!splitContentView}">
        <div class="container-fluid">
            <div class="row">
                <div class="row detailRow" ng-hide="field.name=='id' || field.name=='identifierName' || field.name=='{{header}}' || field.name=='documentExists' || field.name=='referenceFields'"  ng-repeat="field in fields">
